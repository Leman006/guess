...
const ClothingList = ({ gender, categories, baseRoute }) => {
  ...
  <div className="max-w-[1660px] w-full mx-auto px-4 py-20 flex flex-col items-center justify-center text-center">
  <div className="flex flex-col items-center gap-4">
    ...
    <a
      href="/"
      className="mt-6 px-8 py-3 bg-black text-white font-medium uppercase tracking-wide rounded-2xl hover:bg-gray-800 transition"
    >
      Continue Shopping
    </a>
  </div>
